...
public partial class ManageClients : ComponentBase
{
    ...
    private async Task LoadClients()
    {
        ...
        {
            Toast.ShowError("An unexpected error occurred while loading clients.");
        }
        finally
        {
            _loading = false;
    ...
    private async Task LoadReport(Guid clientId)
    {
        ...
        {
            Toast.ShowError("Failed to load client report.");
        }
        finally
        {
    ...
    private async Task ToggleActive()
    {
        ...
        try
        {
            ...
            {
                Toast.ShowError("Failed to update client status.");
            }
        }
        catch (Exception)
        {
            Toast.ShowError("An error occurred while updating status.");
        }
    }
}
